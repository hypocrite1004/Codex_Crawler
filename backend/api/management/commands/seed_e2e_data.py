    ...
    def handle(self, *args, **options):
        ...
        published_with_summary, _ = Post.objects.update_or_create(
            ...
            defaults={
                ...
                'is_summarized': True,
                'summary': json.dumps({
                    'title': 'Seeded Summary',
                    'brief': 'Public visitors can quickly see the affected CVE and IOC before reading the full article.',
                    'summary': 'Seeded summary body',
                    'hashtag': ['#threat-intel', '#patching'],
                }, ensure_ascii=False),
                'iocs': ['198.51.100.77'],
                'is_draft': False,
                'status': 'published',
        ...
        Post.objects.update_or_create(
            title='E2E Related Coverage For Summary',
            defaults={
                'content': '<p>E2E related coverage for the summarized post.</p>',
                'category': news,
                'author': author,
                'site': 'E2E Source',
                'source_url': 'https://example.com/e2e-related-coverage',
                'is_shared': False,
                'is_summarized': False,
                'summary': '',
                'iocs': [],
                'parent_post': published_with_summary,
                'is_draft': False,
                'status': 'published',
